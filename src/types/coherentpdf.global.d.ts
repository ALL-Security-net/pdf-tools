/*
 * coherentpdf.global.d.ts — TypeScript type definitions for PDF Tools / CoherentPDF integration
 *
 * These type definitions were written by Alam for use in the PDF Tools project.
